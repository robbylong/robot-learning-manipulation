...
SUPPORT_DIR = "../src/UCL_AffCorrs/affordance_database/"
...
# object_position = [0.3, -0.05, 0+table_height_offset]  # Specify the position of the object in the world
...
#mug
PATH_TO_obj = OBJECT_PATH +\
                    "/assets/google/Craftsman_Grip_Screwdriver_Phillips_Cushion/model.sdf"

object_position = [0.3, 0.1, 0+table_height_offset]  # Specify the position of the object in the world
object_orientation = p.getQuaternionFromEuler([0, 0, 0])  # Specify the orientation of the object
...
# PATH_TO_output = OBJECT_PATH +\
#                     "/assets/google/Room_Essentials_Bowl_Turquiose/model_convex.obj"
# PATH_TO_obj_file = OBJECT_PATH +\
#                     "/assets/google/Room_Essentials_Bowl_Turquiose/meshes/model.obj"
# PATH_TO_log = OBJECT_PATH +\
#                     "/assets/google/Room_Essentials_Bowl_Turquiose/log.txt"
# vhacd_path = p.vhacd(PATH_TO_obj_file,PATH_TO_output,PATH_TO_log)

# Create an instance of the Object class to import the object
bowl = SDFObject(PATH_TO_obj, object_position, object_orientation)

# bowl = SDFObject(vhacd_path, object_position, object_orientation)
# convex_decomposition_result = p.vhacd(bowl, alpha=0.04, resolution=1000000)
# convex_decomposition_file = OBJECT_PATH +\
#                     "/assets/google/Room_Essentials_Bowl_Turquiose/model_convex.sdf"
#   # Replace with the desired path to save the convex decomposition URDF file
# convex_decomposition_result.save(convex_decomposition_file)
...
# Affcorrs find part #
##############
SUPPORT_DIR = SUPPORT_DIR + input("Enter your support folder for AffCorrs: ")
...
for step in range (N_UP_STEPS):
    ...
    # # Get the contact points in the simulation
    contact_points = p.getContactPoints(rpl_panda_w_gripper.id, bowl.id, 34)
    palm_force = 0
