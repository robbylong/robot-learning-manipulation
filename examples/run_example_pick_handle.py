...
object_position = [0.2, 0, 0+table_height_offset]  # Specify the position of the object in the world
...
object_position = [0.55, -0.3, 0+table_height_offset+0.05]  # Specify the position of the object in the world
...
object_orientation = p.getQuaternionFromEuler([0, 1.5708, 0])  # Specify the orientation of the object
...
# #meshes
# PATH_TO_obj = OBJECT_PATH +\
#                     "/assets/google/Peach/model.sdf"

# object_position = [0.6, -0.3, 0+table_height_offset+0.1]  # Specify the position of the object in the world
# object_orientation = p.getQuaternionFromEuler([0, 0, 0])  # Specify the orientation of the object
